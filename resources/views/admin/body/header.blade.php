...
<span class="text-danger"> Date  {{\Carbon\Carbon::now()->format('d-m-Y h:i A')}} </span> </h2>
...
@endphp
    ...
    <img src="{{ (!empty($Admindata->photo)) ? url('upload/admin_images/'.$Admindata->photo):url('upload/no_image.jpg')  }} " class="user-img" alt="user avatar">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item" href="{{ route('admin.change.password') }}"><i class="bx bx-cog"></i><span>Chnage Password</span></a>
            </li>
