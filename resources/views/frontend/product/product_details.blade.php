                    ...
                    <div class="detail-info pr-30 pl-30">
                        ...
                        @else
                            <div class="attr-detail attr-size mb-30">
                                ...
                                <select class="form-control unicase-foarm-control" id="dsize">
            ...
            class="fi-rs-shopping-cart"></i>Add to cart</button>
                        ...
                        <div class="font-xs">
                            ...
                            <ul class="float-start">
                                ...
                                <li>Stock:<span class="in-stock text-brand ml-5">({{ $product->product_qty }})Items In
                                        Stock</span></li>
                            </ul>
                        </div>
                    </div>
