            ...
            <div class="row product-grid">
                ...
                @endphp
                        ...
                        <div class="product-content-wrap">
                            ...
                            <span class="font-small text-muted">By <a href="{{ route('vendor.details',$vendor->id) }}">Admin</a></span>


                            @else
                            <span class="font-small text-muted">By <a href="{{ route('vendor.details',$vendor->id) }}">{{$product['vendor']['name']  }}</a></span>
                            @endif
