           ...
           <input type="hidden" name="old_image" value="{{$BannerEdit->banner_image}}" >
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="banner_title" class="form-control" value="{{ $BannerEdit->banner_title  }}"   />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class= "form-group col-sm-9 text-secondary">
					<input type="text" name="banner_url" class="form-control"  value="{{ $BannerEdit->banner_url  }}"   />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
                    <img id="showImage" src="{{ asset($BannerEdit->banner_image) }}" alt="Admin" style="width:100px; height: 100px;"  >
				</div>
			</div>
